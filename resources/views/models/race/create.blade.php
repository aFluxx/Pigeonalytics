...
@section('content')
<div class="p-4">
    <h2 class="tw-font-bold tw-text-2xl tw-mb-2">Maak een nieuwe race aan</h2>
    <form action="{{ route('race.store') }}" enctype="multipart/form-data" method="POST" class="tw-w-full tw-max-w-lg">
        ...
        <div class="tw-flex">
            <div class="tw-w-1/2 tw-pr-2">
                <label for="race_dropzone" class="tw-label">Kies losplaats:</label>
                ...
                <label for="race_unloading_time" class="tw-label">Lossingsuur:</label>
                <input type="datetime-local" name="race_unloading_time" id="race_unloading_time" step="1"
                    class="tw-input">

                <label for="race_category" class="tw-label">Categorie</label>
                <select name="race_category" id="race_category" class="tw-input">
                    ...
                    <option value="old_birds">Oude duiven</option>
                    <option value="mix_yearling_old">Mix (jaarlingen/oud)</option>
            ...
            <div>
                ...
                <div>
                    <div id="fon_races" class="tw-hidden">
                        ...
                        <input type="number" id="race_amount_pigeons_club" name="race_amount_pigeons_club"
                            class="tw-input" />

                        <label for="race_amount_pigeons_provincial" class="tw-label">Amount of pigeons
                            (Provincial):</label>
                        ...
                        <input type="number" id="race_amount_pigeons_zone" name="race_amount_pigeons_zone"
                            class="tw-input" />
                    ...
                    <div id="hfo_races" class="tw-hidden">
                        ...
                        <input type="number" id="race_amount_pigeons_regio" name="race_amount_pigeons_regio"
                            class="tw-input" />

                        <label for="race_amount_pigeons_overkoepeling" class="tw-label">Amount of pigeons
                            (Overkoepeling):</label>
                        <input type="number" id="race_amount_pigeons_overkoepeling"
                            name="race_amount_pigeons_overkoepeling" class="tw-input" />
                    </div>
                </div>
            </div>
        </div>
